...
Wolfenstein: Enemy Territory, (or just ET) is an old game but is still incredibly popular at LANs. There is a scholarship (See \ref{camp_scholarship}) available for the camp which requires playing ET. The ET server is at \server{heathred.ucc.asn.au}.

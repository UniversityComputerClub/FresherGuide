...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.75\textwidth]{figures/compiling.png}
	\caption{\url{http://xkcd.com/303}}
	\label{compiling}
\end{figure}

\cfoot{this document was prepared by your friendly neighborhood overlord}
